...
/**
 * \file    test/phpunit/MasterEditorFunctionalTest.php
...
/**
 * Class MasterEditorFunctionalTest
 *
 ...
 *
 * @package Testmastereditor
 */
class MasterEditorFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMasterEditor')->click();
		} else {
			// Disable the module
			$this->byHref('modMasterEditor')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mastereditor/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mastereditor/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mastereditor/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mastereditor/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mastereditorwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMasterEditor_MasterEditorTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMasterEditor_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
